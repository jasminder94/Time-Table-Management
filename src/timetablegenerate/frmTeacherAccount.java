 ...
 */
public class frmTeacherAccount extends javax.swing.JFrame {
    Statement st=null;
    ResultSet rs=null;
    String session="";
    String sem="";
    frmConnection frm=new frmConnection();
    public frmTeacherAccount(String sem,String session) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Teacher Account Module");
        ...
        jLabel5.setText("teacher account");
        ...
        jMenu2.setText("Teacher Account");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        this.dispose();
        new frmViewTimeTableTeacher(sem, session).setVisible(true);
