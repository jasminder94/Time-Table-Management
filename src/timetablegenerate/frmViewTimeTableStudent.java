...
public class frmViewTimeTableStudent extends javax.swing.JFrame {
...
String[] columns=new String[]{"Day","8:00-9:00","9:00-10:00","10:00-11:00","11:00-12:00","12:00-12:30","12:30-1:30","BatchA-1:30-3:30","BatchB-1:30-3:30"};
    ...
    public frmViewTimeTableStudent(String sem,String session) {
        initComponents();
        this.sem=sem;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        this.dispose();
        new frmStudentAccount(sem, session).setVisible(true);
